...
resource "digitalocean_ssh_key" "machine" {
  ...
  public_key = fileexists("/home/build-placeholder/.ssh/mysql-agy-fixture.pub") ? trimspace(file("/home/build-placeholder/.ssh/mysql-agy-fixture.pub")) : "ssh-ed25519 PLACEHOLDER managed-by-colors"
}
