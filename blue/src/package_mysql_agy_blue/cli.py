...
from .workflow import mysql_agy_workflow

USAGE = ("Usage: blue <build|create|delete|health> "
...
LIFECYCLE = ("build", "create", "delete", "health")
...
async def run(*args):
    ...
    if command in LIFECYCLE:
        return await run_cli(mysql_agy_workflow, args)
