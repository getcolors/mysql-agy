...
from package_mysql_agy_blue import ssh, validate
...
def test_a_build_never_names_the_operators_home():
    ...
    assert opts["ssh-private-key-path"] == "/home/build-placeholder/.ssh/mysql-agy-fixture"
    assert opts["ssh-public-key-path"] == "/home/build-placeholder/.ssh/mysql-agy-fixture.pub"
    # The placeholder lands on the provider's own machine-key key.
    assert opts["digitalocean-ssh-keys"] == "/home/build-placeholder/.ssh/mysql-agy-fixture.pub"
...
def test_a_dry_run_is_held_to_the_same_rule_as_a_build():
    ...
    assert ssh.with_machine_key(fixture({"blue/event": "create", "blue/dry-run": True}))[
        "ssh-private-key-path"] == "/home/build-placeholder/.ssh/mysql-agy-fixture"
...
def test_real_events_render_the_real_path():
    ...
    assert opts["ssh-private-key-path"].endswith("/.ssh/mysql-agy-fixture")
