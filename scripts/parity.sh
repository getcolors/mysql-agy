...
diff -r "$root/green/src/resources/io/github/getcolors/mysql_agy" "$root/red/resources"
diff -r "$root/green/src/resources/io/github/getcolors/mysql_agy" "$root/blue/src/package_mysql_agy_blue/resources"
