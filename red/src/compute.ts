...
export function requirements(opts:Opts){
 ...
 return {security:{ingress,egress:'all',private_filter:true},endpoint:{kind:'reserved-ip',assignment:'application'},private:true,legacy_state_keys:[opts.profile+'/mysql-agy-infrastructure.tfstate']};
}
